...
contract Visibility {
    ...
    // private - sadece tanımlandiği contract içerisinde erişilebilir 
    // internal - sadece tanımlandığı contract ve bu contract'ı miras alan child contract'lar tarafından erişilebilir
